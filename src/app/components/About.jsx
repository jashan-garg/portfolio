                    ...
                    >
                        {infoList.map(({ icon, title, description }, index) => (
                            <motion.li
                                key={index}
                                variants={fadeUp}
                                className="bg-white/30 backdrop-blur-sm border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover-light hover:-translate-y-1 duration-500 hover-shadow-light"
                            >
                                <Image
                                    alt={title}
                                    src={icon}
                    ...
                    >
                        {toolsData.map((tool, index) => (
                            <motion.li
                                ...
                                className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer bg-white/60 backdrop-blur-sm"
                            >
                                <Image
                                    alt=""
                                    src={tool}
